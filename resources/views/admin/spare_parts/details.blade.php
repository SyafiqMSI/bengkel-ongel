<x-app-layout>
    ...
    <div id="spareparts" class="flex" style="justify-content: center; margin: 0;">
        ...
        <a href="{{ route('admin.sparepart.details', $sparepart->spare_part_id) }}" class="card spare-part" style="width: 200px; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); background-color: #ffffff; margin: 0px 20px 100px 20px; text-decoration: none; display: inline-block; transition: transform 0.2s;">
