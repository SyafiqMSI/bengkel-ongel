            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-10 text-2xl">
                        <a href="{{ route('admin.spare_parts.create') }}" class="btn btn-black mb-2"
                            style="padding: 12px 20px; background-color: #000; color: #fff; text-decoration: none; border-radius: 8px; font-weight: 600; transition: background-color 0.3s ease;">Add
                            New Spare Part</a>
                    </div>
                                ...
                                @foreach ($spareParts as $sparePart)
                                    <tr>
                                        ...
                                        <div class="flex items-center justify-center">
                                            <x-primary-button style="background-color: rgb(254,245,117); color: black; border: 1px solid gray;" class="ms-1"><a href="{{ route('admin.spare_parts.edit', $sparePart->spare_part_id) }}"
                                                class="btn btn-primary">Edit</a></x-primary-button>
                                                <x-primary-button style="background-color: rgb(116,116,253); color: black; border: 1px solid gray;" class="ms-1"><a href="{{ route('admin.spare_parts.view', $sparePart->spare_part_id) }}"
                                                class="btn btn-info">View</a></x-primary-button>
                                            <form
                                                action="{{ route('admin.spare_parts.destroy', $sparePart->spare_part_id) }}"
