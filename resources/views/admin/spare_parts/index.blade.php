                                    ...
                                    <tr>
                                        ...
                                        <td class="border px-4 py-2">
                                            ...
                                            @elseif ($sparePart->gambar && file_exists(public_path('spare_parts/' . $sparePart->gambar)))
                                                <img src="{{ asset('spare_parts/' . $sparePart->gambar) }}"
                                                    alt="Spare Part Image" class="max-w-xs">
                                            @else
                                                No image available
                                            @endif
                                        ...
                                        <td class="border px-4 py-2">
                                            <a href="{{ route('admin.spare_parts.edit', $sparePart->id_spare_part) }}"
                                                class="btn btn-primary">Edit</a>
                                            <a href="{{ route('admin.spare_parts.view', $sparePart->id_spare_part) }}"
                                                class="btn btn-info">View</a>
                                            <form
                                                action="{{ route('admin.spare_parts.destroy', $sparePart->id_spare_part) }}"
